...
comic10Btn.addEventListener('click', () => loadComic('Assents/universidad/Semestre - copia (2)/\Tic_ii/proyectos_tics/proyecto_latex/sim.pdf'));
comic11Btn.addEventListener('click', () => loadComic('Assents/universidad/Semestre - copia (2)/\Tic_ii/proyectos_tics/proyecto_latex/sim.mp4'));
